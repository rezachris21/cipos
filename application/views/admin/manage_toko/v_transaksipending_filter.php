    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">    
          ...
          <br>
          <div class="col-md-3">
            <a class="btn btn-warning btn-sm" href="<?php echo base_url().'pendingtoko/transaksipending_pdf/?dari='.set_value('dari').'&sampai='.set_value('sampai').'&slcCabang='.set_value('slcCabang') ?>">
