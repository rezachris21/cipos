    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <a href="#tambahuser" data-toggle="modal" class="btn btn-primary btn-sm" onclick="submit('tambah')"><span class="glyphicon glyphicon-plus"></span> Tambah Owner</a>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      $('#demo').submit(function(e){
        e.preventDefault();
        $.ajax({
          url:'<?php echo base_url();?>owner/do_upload',
          type:'POST',
  ...
  function submit(x) //switch tombol tambah/ubah di modal
  {
    ...
    else
    {
      ...
      $.ajax({ // mengambil data untuk ditampilkan di modal
        type:'POST',
        data:'id='+x,
        url:'<?php echo base_url().'owner/ambilid' ?>',
        dataType:'json',
  ...
  function editData() // edit data
  {
    ...
    $.ajax({
      ...
      url:'<?php echo base_url().'owner/editdata' ?>',
      dataType:'json',
      success:function(hasil)
      {
  ...
  function hapus(id) // hapus data
  {
    swal({
      ...
      $.ajax({
        type : 'POST',
        data : 'id='+id,
        url : '<?php echo base_url().'owner/hapusdata' ?>',
        success: function(){
