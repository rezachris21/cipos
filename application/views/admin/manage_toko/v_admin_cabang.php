    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <a href="#tambahuser" data-toggle="modal" class="btn btn-primary btn-sm" onclick="submit('tambah')"><span class="glyphicon glyphicon-plus"></span> Admin Cabang</a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="demo" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Cabang :<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      $('#demo').submit(function(e){
        e.preventDefault();
        $.ajax({
          url:'<?php echo base_url();?>admincabang/do_upload',
          type:'POST',
          ...
          success:function(data)
          {
            ...
            window.location.href="admincabang";
            },2700);
          }
        });
      });
  ...
  function submit(x) //switch tombol tambah/ubah di modal
  {
    ...
    else
    {
      ...
      $.ajax({ // mengambil data untuk ditampilkan di modal
        type:'POST',
        data:'id='+x,
        url:'<?php echo base_url().'admincabang/ambilid' ?>',
        dataType:'json',
        success:function(hasil)
        {
         ...
         $("[name = 'cabang']").val(hasil[0].idcabang);
  ...
  function editData() // edit data
  {
    ...
    $.ajax({
      type:'POST',
      data:'id='+id+'&nama='+nama+'&username='+username+'&password='+password+'&upassword='+upassword+'&cabang='+cabang+'&foto='+foto,
      url:'<?php echo base_url().'admincabang/editdata' ?>',
      dataType:'json',
      success:function(hasil)
      {
  ...
  function hapus(id) // hapus data
  {
    swal({
      ...
      $.ajax({
        type : 'POST',
        data : 'id='+id,
        url : '<?php echo base_url().'admincabang/hapusdata' ?>',
        success: function(){
